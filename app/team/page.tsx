        ...
        <main className="min-h-screen bg-black text-foreground relative overflow-hidden">
            ...
            <div className="relative z-10 pt-32 pb-16 px-8 md:px-16">
                ...
                <div className="text-center mb-12 space-y-6 animate-fade-in-up max-w-7xl mx-auto">
                    ...
                    {/* Role Tabs */}
                    <div className="flex gap-8 justify-center border-b border-white/10 pb-4">
                        <button
                            onClick={() => setActiveRole("Founder")}
                            className={`pb-2 text-sm uppercase tracking-[0.3em] transition-colors relative ${activeRole === "Founder" ? "text-accent" : "text-white/40 hover:text-white/60"
                                }`}
                        >
                            Founders
                            {activeRole === "Founder" && (
                        ...
                        <button
                            ...
                            className={`pb-2 text-sm uppercase tracking-[0.3em] transition-colors relative ${activeRole === "Secretary" ? "text-accent" : "text-white/40 hover:text-white/60"
                                }`}
                        >
                            Secretary
